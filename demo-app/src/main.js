...
const project = {
  ...
  "githubUrl": "https://github.com/Justin21523/amazon-review-intelligence",
  "readmeUrl": "https://github.com/Justin21523/amazon-review-intelligence#readme",
  ...
  "features": [
    "Detected technical signals: Python, FastAPI, Next",
    "js, TypeScript, DuckDB, BM25, Sentence Transformers, scikit-learn, Playwright,README evidence exists and can support a fuller reviewed case study,A public GitHub repository is linked for source traceability",
    "Built a review-centered data product with DuckDB for product and review data, FastAPI for search and recommendation endpoints, and a Next",
    "js dashboard for hybrid search, product summaries, sentiment analytics, recommendations, and evaluation views"
  ],
  "metrics": [
    {
      "label": "Demo Modules",
  ...
  "records": [
    {
      "id": "flow-01",
      "name": "Detected technical signals: Python, FastAPI, Next",
      "status": "Ready",
      "owner": "Frontend"
    },
    {
      "id": "flow-02",
      "name": "js, TypeScript, DuckDB, BM25, Sentence Transformers, scikit-learn, Playwright,README evidence exists and can support a fuller reviewed case study,A public GitHub repository is linked for source traceability",
      "status": "Review",
      "owner": "Data"
    },
    {
      "id": "flow-03",
      "name": "Built a review-centered data product with DuckDB for product and review data, FastAPI for search and recommendation endpoints, and a Next",
      "status": "Queued",
      "owner": "Automation"
    },
    {
      "id": "flow-04",
      "name": "js dashboard for hybrid search, product summaries, sentiment analytics, recommendations, and evaluation views",
      "status": "Ready",
      "owner": "Product"
    }
  ]
